...
void main(){
  ...
  if (c > 8.5 && c < 9.5) {
    ...
    // (the allowance grows with the slider BOTH ways: raised more than 6 m,
    // the river stayed at its old level under the white flood plane)
    if (abs(h - wl) < 6.0 + abs(uDanube)) h = wl;
    else {
